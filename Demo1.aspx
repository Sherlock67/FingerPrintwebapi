                ...
                <table width="1012" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr align="center">
                        ...
                        <span class="download_href"> 
                            ...
                            <br>
                            <p id="result"/>
                            <img id="result1" align="end" height=300 width=210 />
                        </span>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
...
<script type="text/javascript">
    ...
    //function getFromLocalStorage(result) {
       
    //    var tbl1 = "<table border=1>";
    //    tbl1 += "<tr>";
    //    tbl1 += "<td> Fingerprint </td>";
    //    tbl1 += "<td> <b>" + window.localStorage.getItem("base64") + "</b> </td>";
    //    tbl1 += "</tr>";
    //    tbl1 += "<tr>";
    //    //return window.localStorage.getItem("base64");
...
function SuccessFunc(result) {
   ...
   /* getFromLocalStorage();*/
    //var bmp = document.getElementById("FPImage1").value;
    //var template = document.getElementById("tmplt").value;
